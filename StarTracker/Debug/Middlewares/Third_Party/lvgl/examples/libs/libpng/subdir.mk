...
C_SRCS += \
../Middlewares/Third_Party/lvgl/examples/libs/libpng/img_png_demo.c \
../Middlewares/Third_Party/lvgl/examples/libs/libpng/lv_example_libpng_1.c 

OBJS += \
./Middlewares/Third_Party/lvgl/examples/libs/libpng/img_png_demo.o \
./Middlewares/Third_Party/lvgl/examples/libs/libpng/lv_example_libpng_1.o 

C_DEPS += \
./Middlewares/Third_Party/lvgl/examples/libs/libpng/img_png_demo.d \
...
clean-Middlewares-2f-Third_Party-2f-lvgl-2f-examples-2f-libs-2f-libpng:
	-$(RM) ./Middlewares/Third_Party/lvgl/examples/libs/libpng/img_png_demo.cyclo ./Middlewares/Third_Party/lvgl/examples/libs/libpng/img_png_demo.d ./Middlewares/Third_Party/lvgl/examples/libs/libpng/img_png_demo.o ./Middlewares/Third_Party/lvgl/examples/libs/libpng/img_png_demo.su ./Middlewares/Third_Party/lvgl/examples/libs/libpng/lv_example_libpng_1.cyclo ./Middlewares/Third_Party/lvgl/examples/libs/libpng/lv_example_libpng_1.d ./Middlewares/Third_Party/lvgl/examples/libs/libpng/lv_example_libpng_1.o ./Middlewares/Third_Party/lvgl/examples/libs/libpng/lv_example_libpng_1.su
